    ...
    consolidationFarmData.innerHTML = `
        <div class="card readonly-card">
            <div class="card-header">
                <span class="card-title">Dados da Propriedade</span>
                <span class="card-icon">🏡</span>
            </div>
            <div class="form-grid">
                <div class="form-group">
                    <label>Produtor</label>
                    <input type="text" value="${state.farmData.producer || ''}" readonly>
                </div>
                <div class="form-group">
                    <label>Fazenda</label>
                    <input type="text" value="${state.farmData.farm || ''}" readonly>
                </div>
                <div class="form-group">
                    <label>Área (ha)</label>
                    <input type="number" value="${state.farmData.area || ''}" readonly>
                </div>
                <div class="form-group">
                    <label>Cultura</label>
                    <select disabled>
                        <option value="soja" ${state.farmData.culture === 'soja' ? 'selected' : ''}>Soja</option>
                        <option value="milho" ${state.farmData.culture === 'milho' ? 'selected' : ''}>Milho</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Data de Vencimento</label>
                    <input type="date" value="${state.farmData.dueDate || ''}" disabled>
                </div>
                <div class="form-group">
                    <label>Valor do Grão (R$/saca)</label>
                    <input type="number" value="${state.farmData.grainPrice || ''}" readonly>
                </div>
            </div>
        </div>
    `;
